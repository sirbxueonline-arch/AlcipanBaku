...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)] font-sans">
      ...
      {/* HERO SECTION */}
      <section className="relative py-12 md:py-24 px-4 min-h-[65vh] md:min-h-[85vh] flex flex-col justify-center overflow-hidden">
        ...
        <div className="relative z-20 container mx-auto px-4 flex flex-col items-center text-center max-w-7xl pt-12 md:pt-0">
          <div className="mb-3 md:mb-6">
            <span className="text-white/90 font-semibold tracking-[0.2em] uppercase text-xs md:text-sm border-b-2 border-[#fbbf24] pb-2">
                // ALÇİPAN BAKU
            </span>
          </div>
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-5xl md:text-7xl font-extrabold mb-4 md:mb-6 text-white leading-[1.1] tracking-tight max-w-4xl drop-shadow-lg"
          >
          ...
          <motion.h2
            ...
            className="text-lg md:text-3xl font-medium text-[#fbbf24] mb-6 md:mb-10 tracking-wide"
          >
          ...
          <motion.p
            ...
            className="text-sm md:text-xl text-white/90 mb-8 md:mb-12 font-medium max-w-xs md:max-w-2xl mx-auto leading-relaxed"
          >
